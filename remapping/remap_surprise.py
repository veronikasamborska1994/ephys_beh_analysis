...
def through_time_only_diagonal(data, task_1_2 = False, task_2_3 = False, task_1_3 = False):    
    ...
    for  s, sess in enumerate(x):
        ...
        for neuron in range(n_neurons):
            ...
            task_1_mean_a_rev = np.mean(n_firing[task_1_a_pre_baseline_rev], axis = 0)
            task_1_std_a_rev = np.std(n_firing[task_1_a_pre_baseline_rev], axis = 0)   
            ...
            task_1_mean_b_rev = np.mean(n_firing[task_1_b_pre_baseline_rev], axis = 0)
            task_1_std_b_rev = np.std(n_firing[task_1_b_pre_baseline_rev], axis = 0)   
           
            # Task 1 Mean rates on the last 20 A trials
            task_1_mean_a_l = np.mean(n_firing[task_1_a_pre], axis = 0)
            task_1_std_a_l = np.std(n_firing[task_1_a_pre], axis = 0)   
            task_1_mean_a_l_rev = np.mean(n_firing[task_1_a_pre_rev], axis = 0)

            # Task 1 Mean rates on the last 20 B trials
            task_1_mean_b_l = np.mean(n_firing[task_1_b_pre], axis = 0)
            #task_1_std_b_l = np.std(n_firing[task_1_b_pre], axis = 0)
            task_1_mean_b_l_rev = np.mean(n_firing[task_1_b_pre_rev], axis = 0)

            # Task 1 Mean rates on the first 20 A trials
            task_2_mean_a = np.mean(n_firing[task_2_a_post], axis = 0)
            #task_2_std_a = np.std(n_firing[task_2_a_post], axis = 0)   
           
            task_2_mean_a_rev = np.mean(n_firing[task_2_a_post_rev_baseline], axis = 0)
            task_2_std_a_rev = np.std(n_firing[task_2_a_post_rev_baseline], axis = 0)

            # Task 1 Mean rates on the first 20 B trials
            task_2_mean_b = np.mean(n_firing[task_2_b_post], axis = 0)
            #task_2_std_b = np.std(n_firing[task_2_b_post], axis = 0)
            task_2_mean_b_rev = np.mean(n_firing[task_2_b_post_rev_baseline], axis = 0)
            task_2_std_b_rev = np.std(n_firing[task_2_b_post_rev_baseline], axis = 0)

              
            min_std = 2
            
            a_within_1 =  -norm.logpdf(task_1_mean_a_l,task_1_mean_a, (task_1_std_a + min_std))
            a_within_1_rev = -norm.logpdf(task_1_mean_a,task_1_mean_a_rev,(task_1_std_a_rev + min_std))

            b_within_1 = -norm.logpdf(task_1_mean_b_l,task_1_mean_b,(task_1_std_b + min_std))
            b_within_1_rev = -norm.logpdf(task_1_mean_b, task_1_mean_b_rev, (task_1_std_b_rev + min_std))

            a_between = -norm.logpdf(task_2_mean_a,task_1_mean_a, (task_1_std_a + min_std))
            a_between_rev = -norm.logpdf(task_1_mean_a_l, task_2_mean_a_rev,(task_2_std_a_rev + min_std))

            b_between = -norm.logpdf(task_2_mean_b,task_1_mean_b, (task_1_std_b + min_std))
            b_between_rev = -norm.logpdf(task_1_mean_b_l,task_2_mean_b_rev,(task_2_std_b_rev + min_std))
    ...
    surprise_list_neurons_a_a = -np.sqrt(np.nanmean(np.asarray(surprise_list_neurons_a_a), axis = 0))
    surprise_list_neurons_b_b = -np.sqrt(np.nanmean(np.asarray(surprise_list_neurons_b_b), axis = 0))
...
def plot_through_time(HP,PFC):
    ...
    mean_b_b_HP_1_2, mean_a_a_HP_1_2 = through_time_only_diagonal(HP, task_1_2 = True, task_2_3 = False, task_1_3 = False)
    mean_b_b_HP_2_3, mean_a_a_HP_2_3 = through_time_only_diagonal(HP, task_1_2 = False, task_2_3 = True, task_1_3 = False)
    mean_b_b_HP_1_3, mean_a_a_HP_1_3 = through_time_only_diagonal(HP, task_1_2 = False, task_2_3 = False, task_1_3 = True)
    
    mean_b_b_PFC_1_2, mean_a_a_PFC_1_2 = through_time_only_diagonal(PFC, task_1_2 = True, task_2_3 = False, task_1_3 = False)
    mean_b_b_PFC_2_3, mean_a_a_PFC_2_3 = through_time_only_diagonal(PFC, task_1_2 = False, task_2_3 = True, task_1_3 = False)
    mean_b_b_PFC_1_3, mean_a_a_PFC_1_3 = through_time_only_diagonal(PFC, task_1_2 = False, task_2_3 = False, task_1_3 = True)
     
   
     
    within_same_space_a_HP =  mean_a_a_HP_1_3[:63]
    between_same_space_a_HP = mean_a_a_HP_1_3[63:]
     
    within_diff_space_HP = mean_b_b_HP_1_2[:63]
    between_diff_space_HP = mean_b_b_HP_1_2[63:]
    
    within_b_to_init_HP =  mean_b_b_HP_2_3[:63]
    between_b_to_init_HP = mean_b_b_HP_2_3[63:]
    
    within_diff_space_PFC = mean_b_b_PFC_1_2[:63]
    between_diff_space_PFC = mean_b_b_PFC_1_2[63:]
    
    within_same_space_a_PFC =  mean_a_a_PFC_1_3[:63]
    between_same_space_a_PFC = mean_a_a_PFC_1_3[63:]
   
    within_b_to_init_PFC =  mean_b_b_PFC_2_3[:63]
    between_b_to_init_PFC = mean_b_b_PFC_2_3[63:]
    ...
    diff_same_space_HP_perm =  _s_mean_a_a_HP_1_3
     
    diff_dif_space_HP_perm = _s_mean_b_b_HP_1_2
    
    diff_b_to_init_HP_perm =  _s_mean_b_b_HP_2_3
    
    diff_same_space_PFC_perm = _s_mean_a_a_PFC_1_3
    
    diff_dif_space_PFC_perm =  _s_mean_b_b_PFC_1_2
   
    diff_b_to_init_PFC_perm =  _s_mean_b_b_PFC_2_3
