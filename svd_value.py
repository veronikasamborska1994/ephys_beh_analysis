...
def value_reg_svd(data, n = 10, plot_a = False, plot_b = False,  first_half = 1, a ='PFC',perm =False):
...
def real_vs_shuffle(PFC,HP, n = 11,  c = 'grey', area='HP'):
    
    u_v_area_shuffle, u_area_shuffle, v_area_shuffle  = svd_on_coefs(PFC,HP, n = 11,task = 0)
    u_v_area_shuffle_1, u_area_shuffle_1, v_area_shuffle_1  = svd_on_coefs(PFC,HP, n = 11, task = 1)
    u_v_area_shuffle_2, u_area_shuffle_2,  v_area_shuffle_2  = svd_on_coefs(PFC,HP, n = 11, task = 2)
    u_v_area_shuffle_3, u_area_shuffle_3, v_area_shuffle_3 = svd_on_coefs(PFC,HP, n = 11, task = 3)
    ...
    u_v_hp, u_hp, v_hp, within_u_hp,between_u_hp,within_v_hp,between_v_hp,within_uv_hp,between_uv_hp = real_diff(HP, n = 11, a = 'HP', task =0)
    u_v_pfc, u_pfc, v_pfc,within_u_pfc,between_u_pfc,within_v_pfc,between_v_pfc,within_uv_pfc,between_uv_pfc = real_diff(PFC, n = 11, a = 'PFC', task =0)
    ...
    u_v_hp_1, u_hp_1, v_hp_1,  within_u_hp_1, between_u_hp_1, within_v_hp_1, between_v_hp_1, within_uv_hp_1, between_uv_hp_1 = real_diff(HP, n = 11, a = 'HP', task = 1)
    u_v_pfc_1, u_pfc_1, v_pfc_1, within_u_pfc_1,between_u_pfc_1,within_v_pfc_1, between_v_pfc_1, within_uv_pfc_1, between_uv_pfc_1 = real_diff(PFC, n = 11, a = 'PFC', task = 1)
  ...
  # task 1 3 
    ...
    u_v_hp_2, u_hp_2, v_hp_2,  within_u_hp_2, between_u_hp_2, within_v_hp_2 ,between_v_hp_2, within_uv_hp_2, between_uv_hp_2 = real_diff(HP, n = 11, a = 'HP', task = 2)
    u_v_pfc_2, u_pfc_2, v_pfc_2, within_u_pfc_2, between_u_pfc_2, within_v_pfc_2, between_v_pfc_2, within_uv_pfc_2, between_uv_pfc_2  = real_diff(PFC, n = 11, a = 'PFC', task = 2)
...
def svd_on_coefs(PFC,HP, n = 11, task = 0):
    ...
    for indices_PFC in combinations(range(m + n), m):
        ...
        for d in [HP_shuffle,PFC_shuffle]:
            ...
            C_1_b_1_all, C_2_b_1_all, C_3_b_1_all = value_reg_svd(d, n = n, plot_a = False, plot_b = True,  first_half = 1, a = 'perm', perm = True)    
            C_1_a_1_all, C_2_a_1_all, C_3_a_1_all = value_reg_svd(d, n = n, plot_a = True, plot_b = False,  first_half = 1, a = 'perm', perm = True)    
...
def real_diff(d, n = 11, a = 'HP', task =0):
    ...
    C_1_b_1_all, C_2_b_1_all, C_3_b_1_all = value_reg_svd(d, n = n, plot_a = False, plot_b = True,  first_half = 1, a = a, perm = False)    
    C_1_a_1_all, C_2_a_1_all, C_3_a_1_all = value_reg_svd(d, n = n, plot_a = True, plot_b = False,  first_half = 1, a = a, perm = False)    
