...
#    average_within_HP, average_between_HP = sv.svd_plotting(experiment_aligned_HP, tasks_unchanged = True, plot_a = False, plot_b = False, HP = True, average_reward = False, diagonal = True, demean_all_tasks = False)
    ...
    #first, average_between_m478,average_between_y_m478,average_within_x_m478, average_within_m478 = svdu.svd_u_and_v_separately(experiment_aligned_m478, tasks_unchanged = True, plot_a = False, plot_b = False, HP = True, average_reward = False, demean_all_tasks = False, z_score = False)
    #first, average_between_m481,average_between_y_m481,average_within_x_m481, average_within_m481 = svdu.svd_u_and_v_separately(experiment_aligned_m481, tasks_unchanged = True, plot_a = False, plot_b = False, HP = True, average_reward = False, demean_all_tasks = False, z_score = False)
    
    #first, average_between_m486,average_between_y_m486,average_within_x_m486, average_within_m486 = svdu.svd_u_and_v_separately(experiment_aligned_m486, tasks_unchanged = True, plot_a = False, plot_b = False, HP = True, average_reward = False, demean_all_tasks = False, z_score = False)
    #first, average_between_m480,average_between_y_m480,average_within_x_m480, average_within_m480 = svdu.svd_u_and_v_separately(experiment_aligned_m480, tasks_unchanged = True, plot_a = False, plot_b = False, HP = True, average_reward = False, demean_all_tasks = False, z_score = False)
    
    m484 = (np.trapz(average_within_m484) - np.trapz(average_between_m484))/average_within_m484.shape[0]
    m479 = (np.trapz(average_within_m479) - np.trapz(average_between_m479))/average_within_m479.shape[0]
    m483 = (np.trapz(average_within_m483) - np.trapz(average_between_m483))/average_within_m483.shape[0]
    
    HP_area = [m484,m479,m483]
    m478 = (np.trapz(average_within_m478) - np.trapz(average_between_m478))/average_within_m478.shape[0]
    m481 = (np.trapz(average_within_m481) - np.trapz(average_between_m481))/average_within_m481.shape[0]
    m486 = (np.trapz(average_within_m486) - np.trapz(average_between_m486))/average_within_m486.shape[0]
    m480 = (np.trapz(average_within_m480) - np.trapz(average_between_m480))/average_within_m480.shape[0]
