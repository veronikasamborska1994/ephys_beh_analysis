...
def load():
    ...
    HP = io.loadmat('/Users/veronikasamborska/Desktop/HP_exclude_new_file.mat')
    PFC = io.loadmat('/Users/veronikasamborska/Desktop/PFC_exclude_new_file.mat')
...
def heatplot_sort(data, ch = 1, task_1_2  =  True, task_1_3 =  False, task_2_3 =  False): 
   ...
   # ch_1 = ch_1/(np.tile(np.max(ch_1,1), [ch_1.shape[1],1]).T+.0000001)

   # ch_2 = ch_2/(np.tile(np.max(ch_2,1), [ch_2.shape[1],1]).T+.0000001)
